...
class InnerPlaceToTravelActivityCard extends StatefulWidget {
  ...
  InnerPlaceToTravelActivityCard(this.placeToTravel, this.activity, this.addActivity, this.removeActivity);

  @override
  State<InnerPlaceToTravelActivityCard> createState() => _InnerActivityCardState();
}

class _InnerActivityCardState extends State<InnerPlaceToTravelActivityCard>
