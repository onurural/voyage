...
import 'package:voyage/SchedulesScreen/MapsWidget.dart';

import '../PlaceScreen/DescriptionBox.dart';
...
class _ActivitySlideState extends State<ActivitySlide> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      children: [
        ...
        beautifulTimeContainer(widget.activity.beginTime, widget.activity.endTime)
      ...
      items: widget.activity.photos.map((photo) => Container(
      decoration: BoxDecoration(
      ...
      secondChild: DescriptionBox(widget.activity
      .description),
